...
/**************************************************************
  "Slice": analyzes a slice of the cube and it does that by constraining one of 
  the dimensions
...
/**************************************************************
  "Dice": slice in two dimensions and it gives you a chunk of the cube
...
/**************************************************************
  Roll-up: want less detail, in other word, more aggregation.
  Total sales by item
**************************************************************/
...
custID is null give us the data on the face of the cube***/
...
/*** Not supported 
means only see null in storeID and custID, not the itemID ***/
...
/**************************************************************
  WITH ROLLUP
  it is based on the ordering of the attributes in the group by clause
**************************************************************/
