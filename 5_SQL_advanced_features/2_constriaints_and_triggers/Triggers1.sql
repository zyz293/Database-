...
/**************************************************************
  ...
  raise is an error raise command, ignore says simply ignore the update
**************************************************************/
...
/**************************************************************
  ...
  there is a trigger chain, R1 trigger R6
  
  in SQLite roll level triggers are activated immediately after each row level change
**************************************************************/
...
/**************************************************************
  ...
  R7 is interact with R1, before take higher priority
**************************************************************/
