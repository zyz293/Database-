...
/**************************************************************
  SELF-TRIGGERING
  // SQLite does not allow a trigger to be activated more than once
**************************************************************/
...
pragma recursive_triggers = on; /**can be activated many times*/
...
/**************************************************************
  ...
  two triggers activated at the same time and perform at same portion of DB
  
  in SQLite, when you have triggers that are activated at the same time, it 
  apears that the trigger that was created second is the one that is go first
**************************************************************/
...
/**************************************************************
  ...
  watch the order of nested cycle
**************************************************************/
