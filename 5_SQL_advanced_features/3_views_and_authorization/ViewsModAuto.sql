...
/**************************************************************
  ...
  with check option means when the system automatically performs a translation,
  it actually checks to make sure that the translation properly inserted the data
  into the view
**************************************************************/
...
/**************************************************************
  ...
  Due to aggregation
  likewise the SQL standard specifies that views with aggregation need not 
  to be updatable
**************************************************************/
...
/**************************************************************
  ...
  also disallowed because modifications to base table T can have surprising effects
  when T is also referencd in a subquery
**************************************************************/
...
/**************************************************************
  ...
  delete operated in the outer query, which is on Student table
**************************************************************/
...
/**************************************************************
  ...
  when updating the student name and the computer knows it is from Student
  table, so it is modified
**************************************************************/
...
/**************************************************************
  ...
  delete could operate on Student table, or apply table, or both (ambiguity)
**************************************************************/
