...
drop view NonUnique;
drop view Berk;
/* SQLite system does not allow any modifications commands on views directly,
the only way is to use a trigger with instead of key word to translate the modifications 
to the base table*/