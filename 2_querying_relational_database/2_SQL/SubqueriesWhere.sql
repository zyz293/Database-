...
/**************************************************************
  IDs and names of students applying to CS at some college
**************************************************************/
...
/**************************************************************
  ...
  exists test empty or not empty
**************************************************************/
...
/**************************************************************
  ...
  all: check whether the value has a certain relationship with all the results of the sub-query
**************************************************************/
...
**************************************************************/
/*wrong, because four students have the same highest GPA */
select sName, GPA
from Student S1
...
only one college has the highest enrollment, so correct ***/
