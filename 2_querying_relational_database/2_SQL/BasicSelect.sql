...
/*** Same query with Distinct (eliminate duplicates), note difference from algebra ***/
...
/**************************************************************
  All large campuses with CS applicants, we should declare which cName it is
**************************************************************/
...
/*** Then by increasing enrollment, where GPA is ordered first then enrollment ***/
...
/**************************************************************
  Applicants to bio majors, match any major where there's some set of characters
**************************************************************/
