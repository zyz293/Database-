...
fix over counting with the sub query***/
...
select a random college shown as cName***/
...
/**************************************************************
  ...
  having: allow to do is apply conditions to the results of aggregate functions. 
  so the having clause is applied after the goup by clause and it allows us to check 
  conditions that involve the entire group. in contrast the where clause applies to
  one tuple at a time
**************************************************************/
