...
(:***************************************************************
   ...
   find all the of price attributes in the database, assign it the plist as a list
****************************************************************:)
...
(:***************************************************************
   ...
   if we want to obtain the value of attribute, we should include data in the commond
****************************************************************:)
...
(:***************************************************************
   ...
   because price is a string, so ordered by lexical graphic ordering
   
   xs:int turn string to integer
****************************************************************:)
...
(:***************************************************************
   ...
   second commond return without last name tag
   
   third commond return $n, should put it in {}
****************************************************************:)
...
(:***************************************************************
   ...
   have the author as the outer elements
   
   in this solution we  are asuming author last names are unique
****************************************************************:)
